...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3|吕吕|生日快乐|这么久了|没有认真的|给你说过|生日快乐|幸好|你提前|说了|不然|我又要忘记|这次时间|比较多|可以搞点|有意思的东西|希望你|在未来的|学习|和|生活中|不断向前|不断成长|祝愿你|学业有成|少点|社会的毒打|还有就是|要一直|元气满满|开开心心|过好|每一天|然后|在生活中|希望你|收获的|不仅仅|是|个人的|成长|更重要的|是希望|你能在|收获成长|的|同时|也能不被|其他的|东西|影响|祝你|生日快乐|希望|你像这首|暖暖|一样|无论|什么时候|都要一直|暖暖的|生日快乐啊|#rectangle|');
    }
